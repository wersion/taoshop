...
if (isset($set_modules) && $set_modules == TRUE)
{
   ...
   /* 打印快递单标签位置信息 */
    $modules[$i]['config_lable'] = 't_shop_name,' . \Yii::t('shipping', 'lable_box_shop_name') . ',150,29,112,137,b_shop_name||,||t_shop_address,' . \Yii::t('shipping', 'lable_box_shop_address') . ',268,55,105,168,b_shop_address||,||t_shop_tel,' . \Yii::t('shipping', 'lable_box_shop_tel') . ',55,25,177,224,b_shop_tel||,||t_customer_name,' . \Yii::t('shipping', 'lable_box_customer_name') . ',78,23,299,265,b_customer_name||,||t_customer_address,' . \Yii::t('shipping', 'lable_box_customer_address') . ',271,94,104,293,b_customer_address||,||';
