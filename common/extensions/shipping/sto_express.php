...
if (isset($set_modules) && $set_modules == TRUE)
{
   ...
   /* 打印快递单标签位置信息 */
    $modules[$i]['config_lable'] = 't_shop_address,' . \Yii::t('shipping', 'lable_box_shop_address') . ',235,48,131,152,b_shop_address||,||t_shop_name,' . \Yii::t('shipping', 'lable_box_shop_name') . ',237,26,131,200,b_shop_name||,||t_shop_tel,' . \Yii::t('shipping', 'lable_box_shop_tel'). ',96,36,144,257,b_shop_tel||,||t_customer_post,' . \Yii::t('shipping', 'lable_box_customer_post') . ',86,23,578,268,b_customer_post||,||t_customer_address,' . \Yii::t('shipping', 'lable_box_customer_address') . ',232,49,434,149,b_customer_address||,||t_customer_name,' . \Yii::t('shipping', 'lable_box_customer_name') . ',151,27,449,231,b_customer_name||,||t_customer_tel,' . \Yii::t('shipping', 'lable_box_customer_tel') . ',90,32,452,261,b_customer_tel||,||';
